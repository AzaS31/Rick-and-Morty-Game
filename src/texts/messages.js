const messages = {
    ...
    suggestGenerateSecond: `Morty: Let's, uh, generate another value now, I mean, to select a box to keep in the game.`,
    ...
    fairNumber: (round, mortyRand, key, playerNum, boxCount) =>
        ...
        `Morty: KEY${round}=${key}\n` +
        `Morty: So the ${round} fair number is (${mortyRand} + ${playerNum}) % ${boxCount} = ${(mortyRand + playerNum) % boxCount}`,
    ...
    invalidSwitch: `Morty: Just type 0 to switch or 1 to stay, Rick...`
};
